...
from BritefuryJ.Pres.UI import SectionHeading1, SectionHeading3
...
_section_border = SolidBorder(1.0, 3.0, 5.0, 5.0, Color(1.0, 0.75, 0.0), Color(1.0, 1.0, 0.95))
